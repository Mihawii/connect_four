...
const CARD_STYLES = [
  { background: "bg-indigo-500 dark:bg-indigo-600", BGComponent: BGComponent1 },
  { background: "bg-purple-500 dark:bg-purple-600", BGComponent: BGComponent2 },
  { background: "bg-pink-500 dark:bg-pink-600", BGComponent: BGComponent3 },
];
...
const PricingCard = ({
  ...
  return (
    <motion.div
      ...
      className={`relative h-96 w-80 shrink-0 overflow-hidden rounded-xl p-8 ${background} shadow-lg transition-shadow hover:shadow-xl`}
    >
